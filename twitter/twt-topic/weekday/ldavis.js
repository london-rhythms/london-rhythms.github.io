LDAvis = function(to_select, json_file) {
    ...
    color1 = "#3eb4f9", // baseline color for default topic circles and overall term frequencies
    color2 = "#3eb4f9"; // 'highlight' color for selected topics and term-topic frequencies
